<template>
  ...
  <div class="app-container">
    ...
    <el-table style="margin-left:50px" v-if="watchtable==true" :data="list" v-loading="listLoading" element-loading-text="拼命加载中" border fit highlight-current-row>
  ...
  methods: {
    ...
    formatJson(filterVal, jsonData) {
     ...
     handleChange(value) {
      ...
      handleUpdate(){
        console.log('teseer4:'+this.personalInfo.region[0]);
